...
- Replace {{PATH}} with:
    - https://cafeapp{{SITE_ID}}.f5app.dev/coffee         -> request is sent to the service coffee
    - https://cafeapp{{SITE_ID}}.f5app.dev/tea            -> request is sent to the service tea
    - https://cafeapp{{SITE_ID}}.f5app.dev/redirect       -> client is redirected to www.nginx.com
    - https://cafeapp{{SITE_ID}}.f5app.dev/return_page    -> custom page Hello World is returned
    - https://cafeapp{{SITE_ID}}.f5app.dev/proxy          -> requests go to coffee you should see custom headers in the responses
