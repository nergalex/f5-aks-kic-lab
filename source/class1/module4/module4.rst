...
*********************
- Create an account on Major League Cyber `here <https://www.majorleaguecyber.org>`_

2. Capture The Flag
*********************
- Connect to `Capture The Flag server <https://ctfd1.f5app.dev/oauth>`_ using your Major League Cyber's credentials
- ``Authorize f5-k8s-fr-se to access your profile``
- You are redirected to ``Challenges`` that are questions asked during ``Exercise`` in each ``Lab``.
